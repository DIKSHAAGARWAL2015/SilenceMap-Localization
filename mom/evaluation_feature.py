...
def silencemap_beta_highres(eeg, L, Cs, Fs=512, i_ref0=63):
...
def main():
    ...
    parser.add_argument("--K", type=int, default=2, help="Number of silent regions")
    parser.add_argument("--per_region_k", type=int, default=25, help="Nodes per region")
    ...
    beta_raw = silencemap_beta_highres(eeg=eeg, L=L, Cs=Cs_full, Fs=Fs, i_ref0=63)
